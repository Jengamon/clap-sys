use crate::{host::*, id::clap_id, plugin::*};
...
pub const CLAP_EXT_UNDO: &CStr = c"clap.undo/4";
pub const CLAP_EXT_UNDO_CONTEXT: &CStr = c"clap.undo_context/4";
pub const CLAP_EXT_UNDO_DELTA: &CStr = c"clap.undo_delta/4";
